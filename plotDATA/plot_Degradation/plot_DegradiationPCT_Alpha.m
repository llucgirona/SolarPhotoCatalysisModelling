function plot_DegradiationPCT_Alpha(dataI,dataExp,t_C,C,PARAMS,experiment,fullfilenameExcel,posExcel)
    t_I=dataI(:,1);
    I=dataI(:,2);
    ...
    annotation('textbox', [0.7, 0.8, 0.1, 0.1], 'String', ...
        {sprintf('C_{0} = %f', C0), sprintf('α = %f', alpha)}, ...
        'HorizontalAlignment','center','BackgroundColor',"w")
   
    annotation('textbox', [0.7, 0.66, 0.1, 0.1], 'String', ...
        sprintf('R^{2} = %f', R2_Alpha(dataExp,dataI,PARAMS)), ...
        'HorizontalAlignment','center','BackgroundColor',"w")
